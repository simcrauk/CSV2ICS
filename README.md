...
- **Field Mapping** - Maps CSV columns to 23 ICS fields via dropdown selectors with live preview
...
The mapper recognises these 23 ICS fields:
...
- **CSV2ICS_Template.xlsx** — A blank template with all 23 supported column headers, data validation dropdowns, auto-filters, and a **Notes** sheet explaining each column with accepted values and examples. Save the Events sheet as CSV to use with the app.
