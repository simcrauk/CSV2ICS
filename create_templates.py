...
HEADERS = [
    ...
    "Optional Attendees", "Duration", "Timezone"
]

COL_WIDTHS = [22, 14, 14, 12, 12, 8, 25, 30, 15, 25,
              12, 10, 14, 14, 12, 14, 18, 16, 18, 25, 30, 30, 14, 20]
...
def add_notes_sheet(wb):
    ...
    notes_data = [
        ...
        ("Timezone", "IANA timezone for this event", "Europe/London, America/New_York, Asia/Tokyo", "No"),
    ]
...
def create_sample():
    ...
    # Organizer, ReqAttendees, OptAttendees, Duration, Timezone
    samples = [
        ["Team Stand-up", "27/03/2026", "", "09:00", "09:15", "", "Board Room",
         "Daily sync meeting", "Work", "", "CONFIRMED", "1", "OPAQUE", "PUBLIC",
         "5", "Weekday", "30/06/2026", "", "",
         "manager@company.com", "dev1@company.com; dev2@company.com", "pm@company.com", "", "Europe/London"],
        ...
        ["US Team Call", "15/04/2026", "", "15:00", "16:00", "", "",
         "Weekly sync with New York office", "Work", "", "CONFIRMED", "", "OPAQUE", "PUBLIC",
         "15", "Weekly", "", "", "",
         "", "us-team@company.com", "", "", "America/New_York"],
